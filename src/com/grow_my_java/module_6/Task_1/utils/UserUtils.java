...
import com.grow_my_java.module_6.Task_1.source.user.Role;
import com.grow_my_java.module_6.Task_1.source.user.User;
import com.grow_my_java.module_6.Task_1.source.user.UserBuilder;
...
public class UserUtils {
    ...
    public static User login(String username, String password) {
        for (User user : users) {
            if (user.getUsername().equalsIgnoreCase(username) && PasswordUtils.verifyUserPassword(password, new String(user.getPassword()), user.getSalt())) {
                return user;
            }
        }
