...
public class Task_7 {
    ...
    public static void main(String[] args) {
        try (BufferedReader read = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            System.out.println("Enter dimension of the first sequence. ");
            int n = Integer.parseInt(read.readLine());
            int[] firstArray = generateArray(n);
            System.out.print("First array: " + Arrays.toString(firstArray));

            System.out.println("\nEnter dimension of the second sequence. ");
            int m = Integer.parseInt(read.readLine());
            int[] secondArray = generateArray(m);
            System.out.print("Second array: " + Arrays.toString(secondArray));

            int[] newArray = firstArray;

            System.out.println("\nResult after sorting: ");
            //Пэйнб я сортировки не чувствую! - А у тебя её нет!! TODO
